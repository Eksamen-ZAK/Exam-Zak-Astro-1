...
document.querySelector(".text-size-setting").addEventListener("mousedown", () => {
  document.getElementById("text-setting-modal").showModal();
});

document.querySelector(".text-close-button").addEventListener("mousedown", () => {
  document.getElementById("text-setting-modal").close();
  location.reload();
});

document.querySelector(".contrast-setting").addEventListener("mousedown", () => {
  document.getElementById("contrast-setting-modal").showModal();
});

document.querySelector(".contrast-close-button").addEventListener("mousedown", () => {
...
toggleButton2.addEventListener("mousedown", () => {
